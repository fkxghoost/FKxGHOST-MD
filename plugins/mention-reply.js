    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝐅𝐊𝐱𝐆𝐇𝐎𝐒𝐓-𝐌𝐃 🥀",
            body: config.DESCRIPTION || "𝐅𝐊𝐱𝐆𝐇𝐎𝐒𝐓-𝐌𝐃🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/8c4lpm.jpg", // Static image URL
            sourceUrl: "https://api.whatsapp.com/send?phone=923443679346&text=FAMOUS-FK-SAIN-SAVE-DONE°³👨🏻‍💻☠️🚩",
